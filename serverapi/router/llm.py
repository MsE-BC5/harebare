...
async def create_chat(chat: dict, db: Session = Depends(get_db)):
    try:
        ...
        # クライアントから送信したテキストと、DBから取得したユーザー情報を反映したテンプレ
        template = f"""
        ...
        NLP技術を使用して質問のテキストから意図を抽出し、
        質問がキャリアアップ、業界情報、転職相談、スキルセット、キャリアプランニング、面接対策、履歴書作成、
        キャリアチェンジ、職業訓練、ネットワーキング、労働市場、給与交渉、キャリアガイダンス、人材開発、
        職務経歴書、職場のコミュニケーション、キャリアコーチング、業界分析、求人情報、キャリアパス、
        自己啓発、キャリアアドバイス、職業安定、就職活動、労働条件、働き方改革、キャリア目標、人材育成、キャリア評価、職業倫理、
        マタニティキャリア、産休・育休、女性リーダーシップ、キャリアと子育て、パートタイム勤務、時短勤務、女性のネットワーキング、
        ジェンダー平等、キャリア復帰、在宅勤務、キャリアブレイク、女性起業家、女性のメンタリング、ワークライフバランス、
        ダイバーシティ推進、キャリア女性の健康、女性の自己実現、キャリアカウンセリング、二重負担、女性のエンパワーメント、
        など、どのカテゴリーに該当するかを判断します。

        ## {{subject}}に基づいた処理
        {{subject}}の分析結果に基づき、適切な回答を生成します。
        意図がキャリアに関連するものであれば、直接的な回答を提供します。
        意図がキャリア関連でない場合は、「おや？私の専門分野とは違いそうですが一生懸命考えて回答します。」と一番最初に前置きしてから回答します。
